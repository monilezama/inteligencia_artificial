...
#BPA ALGORITMO QUE BUSCA LA RUTA PARA LLEGAR DE UN PUNTO DE INICIO HACIA LA META,NO SIEMPRE ES LA MAS OPTIMA, BUSCA EN ANCHURA
...
sucesores={0:[6,8,9,10],1:[7,12,17],2:[15],3:[4,14,15],4:[3,11,14],5:[11,14,16],6:[0,8],7:[1,8,12,14,17],8:[0,5,6,7],9:[0,13],10:[0,17],11:[4,5,14,16],12:[1,7,15],13:[9],14:[3,4,5,7,11,15],15:[2,3,12,14],16:[5,11],17:[1,7,10]}
...
def ruta(Ce,meta):
	...
	print "Ruta con el algoritmo de BPA", Convertida
...
#Ruta con el algoritmo de BPA ['Paris', 'Dijon', 'Strasbourg']
#costo total 648
#
...
#Ruta con el algoritmo de BPA ['Strasbourg', 'Dijon', 'Paris']
#costo total 648
#
...
#Ruta con el algoritmo de BPA ['Bordeaux', 'Limoges', 'Lyon']
#costo total 609
#
...
#Ruta con el algoritmo de BPA ['Lyon', 'Limoges', 'Bordeaux']
#costo total 609
#--------------------------------------------